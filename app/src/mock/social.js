export const feedPosts = [
  {
    ...
    stats: { distanceKm: 10.0, durationMin: 49, paceMinKm: '4:54', elevationM: 86 },
    splits: [
      { km: 1, pace: '5:02', sec: 302 },
      { km: 2, pace: '4:58', sec: 298 },
      { km: 3, pace: '4:56', sec: 296 },
      { km: 4, pace: '4:55', sec: 295 },
      { km: 5, pace: '4:54', sec: 294 },
      { km: 6, pace: '4:53', sec: 293 },
      { km: 7, pace: '4:52', sec: 292 },
      { km: 8, pace: '4:50', sec: 290 },
      { km: 9, pace: '4:48', sec: 288 },
      { km: 10, pace: '4:43', sec: 283 },
    ],
    hr: { avg: 162, max: 181, zones: [
      { z: 1, min: 3 }, { z: 2, min: 9 }, { z: 3, min: 17 }, { z: 4, min: 15 }, { z: 5, min: 5 },
    ] },
  ...
  },
  {
    ...
    stats: { distanceKm: 60.4, durationMin: 142, calories: 1340, elevationM: 420, avgKmh: 25.5 },
    hr: { avg: 128, max: 156, zones: [
      { z: 1, min: 12 }, { z: 2, min: 58 }, { z: 3, min: 42 }, { z: 4, min: 24 }, { z: 5, min: 6 },
    ] },
    kudos: 18,
    comments: [],
    kudoed: false,
...
export const userPosts = [
  ...
  },
  {
    ...
    stats: { distanceKm: 5.1, durationMin: 28, paceMinKm: '5:29', elevationM: 32 },
    splits: [
      { km: 1, pace: '5:34', sec: 334 },
      { km: 2, pace: '5:31', sec: 331 },
      { km: 3, pace: '5:29', sec: 329 },
      { km: 4, pace: '5:27', sec: 327 },
      { km: 5, pace: '5:25', sec: 325 },
    ],
    hr: { avg: 139, max: 148, zones: [
      { z: 1, min: 8 }, { z: 2, min: 14 }, { z: 3, min: 6 }, { z: 4, min: 0 }, { z: 5, min: 0 },
    ] },
    kudos: 12,
    comments: [],
    kudoed: false,
