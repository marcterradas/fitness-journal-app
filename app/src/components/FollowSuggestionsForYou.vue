...
const suggestions = ref([
  { id: 1, name: 'Ava Smith', username: 'ava_fit', avatar: 'https://i.pravatar.cc/150?u=ava', following: false },
  { id: 2, name: 'Liam Turner', username: 'liam_lifts', avatar: 'https://i.pravatar.cc/150?u=liam', following: false },
  { id: 3, name: 'Maya Lee', username: 'maya_moves', avatar: 'https://i.pravatar.cc/150?u=maya', following: false },
  { id: 4, name: 'Noah Reed', username: 'noah_runs', avatar: 'https://i.pravatar.cc/150?u=noah', following: false }
])
...
<template>
  <div class="follow-suggestions">
    <div class="follow-suggestions__header">
      <h3 class="follow-suggestions__title">Suggested for you</h3>
    </div>
